...
- [ ] **Email CC/BCC - ensure CC/BCC list is not visible in email/header** (using [Mailtrap.io example]([https://mailtrap.io/blog/laravel-send-email-gmail/#How-to-send-emails-using-Laravel-and-Gmail-SMTP](https://mailtrap.io/blog/laravel-send-email-gmail/#Send-email-to-multiple-recipients)))
