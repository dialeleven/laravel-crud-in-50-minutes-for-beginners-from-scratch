...
<div class="flex flex-col md:flex-row">
   ...
   <div id="sidebar" class="w-full md:w-1/6 md:block hidden bg-gradient-to-b from-slate-300 from-5% via-slate-200 via-15% to-slate-100 to-90% text-center py-4 rounded-b-lg">

      <aside class="flex flex-col px-5 py-3 overflow-y-auto border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
         ...
         <div class="flex flex-col justify-between flex-1 mt-6">
            <nav class="flex-1 -mx-3 space-y-3 ">
               ...
               <a href="{{ route('product.index') }}" class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-600
            ...
            <div class="mt-6">
               <div class="flex items-center justify-between mt-6">
                  <a href="#" class="flex items-center gap-x-2">
                     ...
                     <span class="text-sm font-medium text-gray-700 dark:text-gray-200">@yield('username', 'Jon Doe')</span>
                  </a>
