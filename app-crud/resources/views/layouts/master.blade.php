...
<div class="w-full md:w-1/6 bg-slate-300 md:hidden block pt-2">
   <a href="#" id="burgerIcon" class="inline-block p-1 ml-1 rounded-md hover:bg-slate-100 transition duration-300">
...
<div class="flex flex-col md:flex-row">
   ...
   <div id="sidebar" class="w-full md:w-1/6 md:block hidden text-center py-4">
      ...
      <aside class="flex flex-col px-5 py-3 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
         ...
         <div class="flex flex-col justify-between flex-1 mt-6">
            <nav class="flex-1 -mx-3 space-y-3 ">
               ...
               <a href="{{ route('product.index') }}" class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
