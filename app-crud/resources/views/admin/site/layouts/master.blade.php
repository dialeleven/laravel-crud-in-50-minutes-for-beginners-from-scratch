...
<div class="flex flex-col md:flex-row">
   ...
   <div id="sidebar" class="w-full md:w-1/6 md:block hidden bg-gradient-to-b from-gray-600 from-60% via-gray-500 via-80% to-gray-500 text-center rounded-b-lg">
      ...
      <aside class="flex flex-col px-5 py-3 overflow-y-auto rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
         ...
         <!-- logo -->
         <a href="{{ route('admin.index') }}" style="display: flex; align-items: center; text-decoration: none;">
         ...
         <div class="flex flex-col justify-between flex-1 mt-6">
            <nav class="flex-1 -mx-3 space-y-3 ">
               ...
               <a href="{{ route('admin.index') }}" class="group flex items-center px-3 py-2 text-blue-100 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-600
                hover:border-gray-500 dark:hover:border-gray-200 border border-transparent">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 transition-transform duration-300 ease-in-out transform group-hover:scale-125">
               ...
               <ul>
                  ...
                  <li>
                     <a href="#" class="group flex items-center px-5 py-2 text-blue-100 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700
                     hover:border-gray-500 dark:hover:border-gray-200 border border-transparent">
               ...
               <a href="{{ route('adminusers.index') }}" class="group flex items-center px-3 py-2 text-blue-100 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700
                hover:border-gray-500 dark:hover:border-gray-200 border border-transparent">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 transition-transform duration-300 ease-in-out transform group-hover:scale-125">
               ...
               <!--
               <a href="#" class="group flex items-center px-3 py-2 text-blue-100 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700
               hover:border-gray-500 dark:hover:border-gray-200 border border-transparent">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 transition-transform duration-300 ease-in-out transform group-hover:scale-125">
               ...
               <a class="group flex items-center px-3 py-2 text-blue-100 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700
                hover:border-gray-500 dark:hover:border-gray-200 border border-transparent
               ...
               -->
               <a href="{{route('weatherapi.index')}}" target="_blank" class="group flex items-center px-3 py-2 text-blue-100 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700
               hover:border-gray-500 dark:hover:border-gray-200 border border-transparent">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 transition-transform duration-300 ease-in-out transform group-hover:scale-125">
                     <title>Weather</title>
            ...
            <div class="mt-6">
               <div class="flex items-center justify-between mt-6">
                  ...
                  {{-- <a href="javascript:void" onclick="document.getElementById('logout-form').submit();" class="group text-white transition-colors duration-200 rotate-180 dark:text-gray-400 rtl:rotate-0 "> --}}
                  <a href="javascript:void" onclick="document.getElementById('logout-form').submit();" class="group flex px-2 py-2 text-blue-100 rotate-180 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 hover:text-gray-700
                  hover:border-gray-500 border border-transparent rtl:rotate-0">
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 transition-transform duration-300 ease-in-out transform group-hover:scale-150">
                        <title>Log out</title>
